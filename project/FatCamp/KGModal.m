...
- (id)init{
    ...
    self.mBackgroundColor = [UIColor whiteColor];
    self.mBorderColor = [UIColor blackColor];
    self.mCornerRadius = 4.0;
...
//    //changing padding to 13 prevent background color overflow around the contentview. changed on 11/23, 2012.
//    CGFloat padding = 13;
...
- (id)initWithFrame:(CGRect)frame{
    ...
    CALayer *styleLayer = [[CALayer alloc] init];
    styleLayer.cornerRadius = [[KGModal sharedInstance] mCornerRadius];
    styleLayer.shadowColor= [[UIColor blackColor] CGColor];
    styleLayer.shadowOffset = CGSizeMake(0, 0);
    styleLayer.shadowOpacity = 0.5;
    styleLayer.borderWidth = [[KGModal sharedInstance] mBorderWidth];;
    styleLayer.borderColor = [[[KGModal sharedInstance] mBorderColor] CGColor];
    styleLayer.backgroundColor = [[[KGModal sharedInstance] mBackgroundColor] CGColor];
    styleLayer.frame = CGRectInset(self.bounds, 12, 12);
    [self.layer addSublayer:styleLayer];
